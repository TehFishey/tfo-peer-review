        ...
        return(
            <div className="App-footer">
                ...
                <div style={{gridArea:"copyright", margin: "auto 0px", overflow: "hidden"}}>
                    <div className='footer-attribution' style={{fontSize: '10px', fontStyle: 'italic'}}>tfo-peer-review version 1.1.1  <button className='footer-changelog' onClick={()=>this.showChangelog()}>Changelog</button></div>
